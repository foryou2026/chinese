...
## 2. 菜单暴露矩阵（与 `B04-design/design-system/03-navigation.md` 完全对齐）
...
- 修改菜单暴露 → 必须先改 [`B04-design/design-system/03-navigation.md`](../B04-design/design-system/03-navigation.md) + 本文件 §2 → 再改代码；
