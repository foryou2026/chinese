<!-- TARGET-PATH: docs/B04-design/design-system/06-responsive-dark.md -->

# 06 · 响应式与暗黑模式

> **阶段**：B04-S  
> **上游**：`01-tokens.md`、`B01-architecture/07-i18n-responsive.md`、`grules/G2-视觉与交互风格/06-响应式与暗黑模式.md`  
