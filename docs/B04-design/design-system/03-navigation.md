...
| 菜单 | 路由 | 图标 | 可见角色 | 备注 |
|------|------|------|---------|------|
| 用户管理 | `/admin/users` | `users` | `super_admin` | 列表只列 `role='user'`；详见 [B02 §3](../../B02-permissions/01-roles.md) |
...
> PM 决策（[B02-permissions `_input/roles-input.md`](../../B02-permissions/_input/roles-input.md)）：本期一律视为超管兼任。
