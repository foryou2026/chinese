<!-- TARGET-PATH: docs/C05-prd/discover-china/app/07-business-rules.md -->

> **本文件为 surface=`app` 视角的 PRD 章节(Round 2 从 PRD.md 第 7 章拆出初版,后续按端过滤实质内容)。** 跨端通用术语见 [_shared/glossary.md](../_shared/glossary.md),跨端业务规则见 [_shared/business-rules.md](../_shared/business-rules.md)。
