<!-- TARGET-PATH: docs/C05-prd/auth/app/06-page-specs/P-app-auth-004.md -->
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C03-pages/auth/app/P-app-auth-004.md`](../../../../C03-pages/auth/app/P-app-auth-004.md) |
| 场景脚本(N) | [`C03-pages/auth/app/P-app-auth-004.scenarios.md`](../../../../C03-pages/auth/app/P-app-auth-004.scenarios.md)(若存在) |
...
- 主要组件:见 [`C03-pages/auth/app/P-app-auth-004.md` §视觉与组件](../../../../C03-pages/auth/app/P-app-auth-004.md)。
