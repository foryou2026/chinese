<!-- TARGET-PATH: docs/C05-prd/app-auth/app/03-personas.md -->

# 03 · 角色与画像

> 详细角色定义见 [`B02-permissions/01-roles.md`](../../B02-permissions/01-roles.md)，本节只摘录与 `app-auth` 相关部分。
...
- 走 [`admin-auth` feature](../../C05-prd/admin-auth/00-index.md) (批次 4)
