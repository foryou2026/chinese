<!-- TARGET-PATH: docs/C05-prd/course/admin/06-page-specs/P-admin-course-002.md -->
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C03-pages/course/admin/P-admin-course-002.md`](../../../../C03-pages/course/admin/P-admin-course-002.md) |
| 场景脚本(N) | [`C03-pages/course/admin/P-admin-course-002.scenarios.md`](../../../../C03-pages/course/admin/P-admin-course-002.scenarios.md)(若存在) |
...
- 主要组件:见 [`C03-pages/course/admin/P-admin-course-002.md` §视觉与组件](../../../../C03-pages/course/admin/P-admin-course-002.md)。
