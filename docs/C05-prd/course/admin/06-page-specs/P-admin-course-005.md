<!-- TARGET-PATH: docs/C05-prd/course/admin/06-page-specs/P-admin-course-005.md -->
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C03-pages/course/admin/P-admin-course-005.md`](../../../../C03-pages/course/admin/P-admin-course-005.md) |
| 场景脚本(N) | [`C03-pages/course/admin/P-admin-course-005.scenarios.md`](../../../../C03-pages/course/admin/P-admin-course-005.scenarios.md)(若存在) |
| HTML 原型(H) | [`C04-prototype/course/admin/`](../../../../C04-prototype/course/admin/) |
...
- 主要组件:见 [`C03-pages/course/admin/P-admin-course-005.md` §视觉与组件](../../../../C03-pages/course/admin/P-admin-course-005.md)。
