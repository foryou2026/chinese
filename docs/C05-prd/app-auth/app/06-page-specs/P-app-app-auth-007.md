<!-- TARGET-PATH: docs/C05-prd/app-auth/app/06-page-specs/P-app-app-auth-007.md -->

# Page Spec · P-app-app-auth-007 · 会话管理 / 全局登出
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C03-pages/app-auth/app/P-app-app-auth-007.md`](../../../../C03-pages/app-auth/app/P-app-app-auth-007.md) |
| 场景脚本(N) | [`C03-pages/app-auth/app/P-app-app-auth-007.scenarios.md`](../../../../C03-pages/app-auth/app/P-app-app-auth-007.scenarios.md)(若存在) |
...
- 主要组件:见 [`C03-pages/app-auth/app/P-app-app-auth-007.md` §视觉与组件](../../../../C03-pages/app-auth/app/P-app-app-auth-007.md)。
...
| 状态 | 路径 |
|------|------|
| 正常态 | `assets/screenshots/P-app-app-auth-007.png`(占位) |
