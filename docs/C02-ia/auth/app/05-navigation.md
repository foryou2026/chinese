<!-- TARGET-PATH: docs/C02-ia/auth/app/05-navigation.md -->
...
| 右上 3 | 「登录」文字按钮 | 跳 `P-auth-001` 并带 `redirect=<当前URL>` |
| 右上 4 | 「注册」主按钮 | 跳 `P-auth-002` |
...
| - 分割线 - |
| 6 | 退出登录 | 触发 SM-03 `signOut`，跳 `P-auth-001` | **auth** |
