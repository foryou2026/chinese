...
- 错误内联在字段下方，4xx 不弹 Toast；5xx 才弹 Toast（按 [B04 §05](../../B04-design/design-system/05-interactions.md)）。
...
- `/401`、`/403`、`/404` 见 [B04 §02](../../B04-design/design-system/02-layout.md)，本 feature 不重新设计；
