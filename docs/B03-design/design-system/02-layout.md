<!-- TARGET-PATH: docs/B03-design/design-system/02-layout.md -->

# 02 · 全局布局

> **阶段**：B03-S  
> **上游**：`01-tokens.md`、`B02-ux/05-moodboard.md`、`B02-ux/06-experience-principles.md`  
> **下游**：所有 C05 H 原型、所有 C04 N 页面骨架  
> **冻结状态**：已冻结 · 2026-04-28
...
### 5.1 空状态（来自 [B03 §不让用户等](../../B02-ux/06-experience-principles.md)）
