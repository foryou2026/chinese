<!-- TARGET-PATH: docs/C06-prd/auth/admin/06-page-specs/P-admin-auth-004.md -->

# Page Spec · P-admin-auth-004 · 管理员列表 / 邀请(super)
...
| 字段 | 值 |
|------|----|
| P-ID | `P-admin-auth-004` |
| 标题 | 管理员列表 / 邀请(super) |
| feature | `auth` |
| surface | `admin` |
| 路由(规范) | 见 [C02 05-navigation.md](../../../../C03-ia/auth/admin/05-navigation.md) |
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C04-pages/auth/admin/P-admin-auth-004.md`](../../../../C04-pages/auth/admin/P-admin-auth-004.md) |
| 场景脚本(N) | [`C04-pages/auth/admin/P-admin-auth-004.scenarios.md`](../../../../C04-pages/auth/admin/P-admin-auth-004.scenarios.md)(若存在) |
| HTML 原型(H) | [`C05-prototype/auth/admin/`](../../../../C05-prototype/auth/admin/) |
| 关联 M-ID | [`C03-ia/auth/admin/01-feature-catalog.md`](../../../../C03-ia/auth/admin/01-feature-catalog.md) |
...
2. 主操作 → 详细见 C03 §3。
3. 异常 / 边界 → 见 C03 §5。
4. 离开 / 跳转 → 见 [`C02 02-flows.md`](../../../../C03-ia/auth/admin/02-flows.md)。
...
- 主要组件:见 [`C04-pages/auth/admin/P-admin-auth-004.md` §视觉与组件](../../../../C04-pages/auth/admin/P-admin-auth-004.md)。
