<!-- TARGET-PATH: docs/C06-prd/auth/admin/06-page-specs/P-admin-auth-002.md -->
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C04-pages/auth/admin/P-admin-auth-002.md`](../../../../C04-pages/auth/admin/P-admin-auth-002.md) |
| 场景脚本(N) | [`C04-pages/auth/admin/P-admin-auth-002.scenarios.md`](../../../../C04-pages/auth/admin/P-admin-auth-002.scenarios.md)(若存在) |
...
- 主要组件:见 [`C04-pages/auth/admin/P-admin-auth-002.md` §视觉与组件](../../../../C04-pages/auth/admin/P-admin-auth-002.md)。
