<!-- TARGET-PATH: docs/C06-prd/auth/app/06-page-specs/P-app-auth-004.md -->

# Page Spec · P-app-auth-004 · 忘记密码 / 重置
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C04-pages/auth/app/P-app-auth-004.md`](../../../../C04-pages/auth/app/P-app-auth-004.md) |
| 场景脚本(N) | [`C04-pages/auth/app/P-app-auth-004.scenarios.md`](../../../../C04-pages/auth/app/P-app-auth-004.scenarios.md)(若存在) |
...
- 主要组件:见 [`C04-pages/auth/app/P-app-auth-004.md` §视觉与组件](../../../../C04-pages/auth/app/P-app-auth-004.md)。
