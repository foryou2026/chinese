<!-- TARGET-PATH: docs/C06-prd/auth/app/06-page-specs/P-app-auth-001.md -->

# Page Spec · P-app-auth-001 · 登录(邮箱密码)
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C04-pages/auth/app/P-app-auth-001.md`](../../../../C04-pages/auth/app/P-app-auth-001.md) |
| 场景脚本(N) | [`C04-pages/auth/app/P-app-auth-001.scenarios.md`](../../../../C04-pages/auth/app/P-app-auth-001.scenarios.md)(若存在) |
...
- 主要组件:见 [`C04-pages/auth/app/P-app-auth-001.md` §视觉与组件](../../../../C04-pages/auth/app/P-app-auth-001.md)。
