<!-- TARGET-PATH: docs/C06-prd/auth/app/06-page-specs/P-app-auth-009.md -->

# Page Spec · P-app-auth-009 · 会话过期 / 重新登录
...
| feature | `auth` |
| surface | `app` |
| 路由(规范) | 见 [C02 05-navigation.md](../../../../C03-ia/auth/app/05-navigation.md) |
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C04-pages/auth/app/P-app-auth-009.md`](../../../../C04-pages/auth/app/P-app-auth-009.md) |
| 场景脚本(N) | [`C04-pages/auth/app/P-app-auth-009.scenarios.md`](../../../../C04-pages/auth/app/P-app-auth-009.scenarios.md)(若存在) |
| HTML 原型(H) | [`C05-prototype/auth/app/`](../../../../C05-prototype/auth/app/) |
| 关联 M-ID | [`C03-ia/auth/app/01-feature-catalog.md`](../../../../C03-ia/auth/app/01-feature-catalog.md) |
...
2. 主操作 → 详细见 C03 §3。
3. 异常 / 边界 → 见 C03 §5。
4. 离开 / 跳转 → 见 [`C02 02-flows.md`](../../../../C03-ia/auth/app/02-flows.md)。
...
- 主要组件:见 [`C04-pages/auth/app/P-app-auth-009.md` §视觉与组件](../../../../C04-pages/auth/app/P-app-auth-009.md)。
