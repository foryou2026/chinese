<!-- TARGET-PATH: docs/C06-prd/course/admin/06-page-specs/P-admin-course-005.md -->

# Page Spec · P-admin-course-005 · 题目 / 知识点 CRUD
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C04-pages/course/admin/P-admin-course-005.md`](../../../../C04-pages/course/admin/P-admin-course-005.md) |
| 场景脚本(N) | [`C04-pages/course/admin/P-admin-course-005.scenarios.md`](../../../../C04-pages/course/admin/P-admin-course-005.scenarios.md)(若存在) |
| HTML 原型(H) | [`C05-prototype/course/admin/`](../../../../C05-prototype/course/admin/) |
| 关联 M-ID | [`C03-ia/course/admin/01-feature-catalog.md`](../../../../C03-ia/course/admin/01-feature-catalog.md) |
...
2. 主操作 → 详细见 C03 §3。
3. 异常 / 边界 → 见 C03 §5。
4. 离开 / 跳转 → 见 [`C02 02-flows.md`](../../../../C03-ia/course/admin/02-flows.md)。
...
- 主要组件:见 [`C04-pages/course/admin/P-admin-course-005.md` §视觉与组件](../../../../C04-pages/course/admin/P-admin-course-005.md)。
