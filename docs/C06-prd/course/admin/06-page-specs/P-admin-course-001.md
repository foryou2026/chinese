<!-- TARGET-PATH: docs/C06-prd/course/admin/06-page-specs/P-admin-course-001.md -->

# Page Spec · P-admin-course-001 · 轨道列表
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C04-pages/course/admin/P-admin-course-001.md`](../../../../C04-pages/course/admin/P-admin-course-001.md) |
| 场景脚本(N) | [`C04-pages/course/admin/P-admin-course-001.scenarios.md`](../../../../C04-pages/course/admin/P-admin-course-001.scenarios.md)(若存在) |
...
- 主要组件:见 [`C04-pages/course/admin/P-admin-course-001.md` §视觉与组件](../../../../C04-pages/course/admin/P-admin-course-001.md)。
