<!-- TARGET-PATH: docs/C06-prd/course/admin/06-page-specs/P-admin-course-002.md -->

# Page Spec · P-admin-course-002 · 阶段编辑
...
| 维度 | 文档 |
|------|------|
| 交互规范(N) | [`C04-pages/course/admin/P-admin-course-002.md`](../../../../C04-pages/course/admin/P-admin-course-002.md) |
| 场景脚本(N) | [`C04-pages/course/admin/P-admin-course-002.scenarios.md`](../../../../C04-pages/course/admin/P-admin-course-002.scenarios.md)(若存在) |
...
- 主要组件:见 [`C04-pages/course/admin/P-admin-course-002.md` §视觉与组件](../../../../C04-pages/course/admin/P-admin-course-002.md)。
