<!-- TARGET-PATH: docs/C06-prd/course/admin/02-glossary.md -->
...
| **撤回（unpublish）** | 内容从学员侧下架；`admin` 二次确认后生效；影响学员当前游标节时回滚到上一个 published 版本 |
| **灰度** | 仅对部分订阅用户可见；首版.0 不做，Round 10+ 评估 |
