<!-- TARGET-PATH: docs/C06-prd/course/app/03-personas.md -->

# 03 · 画像与场景 · course / **app**

> 项目角色定义见 [B02-01](../../../C02-permissions/01-roles.md);app 端唯一角色 `learner`。
...
| 角色 | 场景 | 主要页面 |
|------|------|---------|
| `anonymous` | 试学引导(2025-11 后默认入口前限,需先注册) | [P-app-auth-002](../../../auth/app/06-page-specs/P-app-auth-002.md) |
