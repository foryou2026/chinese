...
| 卡片 | 图标 | 描述 | 跳转 | 状态 |
|------|------|------|------|------|
| 资料 | `user-circle` | 头像 / 显示名 / 偏好语言 | 对应页面 | 启用 |
| 账号与安全 | `shield` | 修改密码 / 退出登录 | 对应页面 | 启用 |
| 我的钱包 | `wallet` | 充值 / 余额 | 对应页面 | **禁用 + 「即将推出」徽标** |
| 订单与会员 | `receipt` | 订单 / 会员等级 | 对应页面 | 禁用 + 即将推出 |
| 邀请好友 | `gift` | 邀请码 / 奖励 | 对应页面 | 禁用 + 即将推出 |
| 设置 | `settings` | 语言 / 主题 | 对应页面 | 禁用 + 即将推出 |
