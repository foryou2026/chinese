...
- **5 语 locale 集合**:`zh/en/vi/th/id`(与 [`C02-permissions/02-authz-mechanism.md §4`](../../C02-permissions/02-authz-mechanism.md) / discover-china C01 §4 全局对齐);多语字段统一形如 `title_i18n: { zh, en, vi, th, id }`,前端按 `users.ui_lang` 取值,缺失回退 `zh`;
