...
|------|------|-----------|---------|------|
| success | 翡翠 emerald | #10B981 | #ECFDF5 | 操作成功、正确答案、在线状态 |
| warning | 琥珀 amber | #F59E0B | #FFFBEB | 警告提示、即将过期、弱网 |
| danger | 红 red | #EF4444 | #FEF2F2 | 操作失败、错误答案、表单校验错误 |
| info | 蓝 blue | #3B82F6 | #EFF6FF | 信息提示、帮助说明、新功能标记 |
