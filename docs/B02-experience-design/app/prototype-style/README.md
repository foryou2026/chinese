...
- CSS：`--color-* / --space-* / --text-* / --lh-* / --radius-* / --shadow-* / --motion-* / --z-* / --font-* / --glass-* / --bg-page*`
...
| parts/01-base.css | reset + 宣纸背景 + 毛玻璃面板 + 排版 + 容器 + 中国文化元素 |
...
3. 严禁直接引用具体色族（如 `--color-ink-700`）；只用 `--color-brand-*`
4. 严禁正文/表单使用行楷字（`--font-brush` 仅限品牌名/Hero H1/印鉴）
