/**
 * app.js — admin 版 window.proto
 * 纯 vanilla JS，零依赖
 * 支持双轴切换：mode × density（admin 无 accent 切换）
 */
(function () {
  'use strict';

  var STORAGE_KEY_MODE    = 'admin-proto-mode';
  var STORAGE_KEY_DENSITY = 'admin-proto-density';
  var html = document.documentElement;

  var VALID_MODES    = ['light', 'dark', 'auto'];
  var VALID_DENSITIES = ['default', 'compact'];

  var proto = {};

  proto.bootstrap = function () {
    var savedMode    = localStorage.getItem(STORAGE_KEY_MODE)    || 'light';
