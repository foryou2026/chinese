<!-- TARGET-PATH: docs/B02-experience-design/design-system/04-status-colors.md -->

# 04 · 状态色与基础组件

> **阶段**：B02-XS  
> **上游**：`01-tokens.md`、`04-voice-tone.md`、`B02-ux/06-experience-principles.md`  
...
| Loading | — | 同原态 + 左侧 14px Spinner | 文字保持 | — | 同 | — | 自动禁用点击；见 [06-interactions §1](./06-interactions.md) |
...
> Toast **只用于“不可恢复错误（5xx / 网络）/ 信息确认”**；表单字段错误一律内联（[06-interactions §8](./06-interactions.md)）。
