<!-- TARGET-PATH: docs/B02-experience-design/design-system/02-layout.md -->

# 02 · 全局布局

> **阶段**：B02-XS  
> **上游**：`01-tokens.md`、`05-moodboard.md`、`B02-ux/06-experience-principles.md`  
...
### 5.1 空状态（来自 [B03 §不让用户等](../../06-experience-principles.md)）
