<!-- TARGET-PATH: docs/B02-experience-design/prototype-style/README.md -->
...
```html
<link rel="stylesheet" href="../../../prototype-style/tokens.css">
<link rel="stylesheet" href="../../../prototype-style/themes.css">
<link rel="stylesheet" href="../../../prototype-style/app.css">
<script defer src="../../../prototype-style/app.js"></script>
```
...
若 feature 沿用一套已成型的视觉结构(类名 / 主题),允许在 `docs/B03-design/prototype-style/<feature>/` 下放置该 feature 专属的 `styles.css` / `prototype.js`,HTML 引用路径与通用包同样为 `../../../prototype-style/<feature>/X`(3 ups)。仍然**只引用、不拷贝**。
