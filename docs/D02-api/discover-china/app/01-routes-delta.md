<!-- TARGET-PATH: docs/D02-api/discover-china/app/01-routes-delta.md -->

> **本文件为 surface=`app` 的视角拷贝(Round 1 物理拆分初版,Round 3+ 将按端裁剪路由前缀 `/api/app/v1/*` 与该端 endpoints)。** 跨端共享的错误码/并发/事件见 [../04-error-codes.md](../04-error-codes.md) 等根级文件。
