<!-- TARGET-PATH: docs/C02-ia-interaction/course/07-error-pages.md -->
...
| `404` | 节 / KP / 题 id 不存在 | 404 + 返回上一级 | 所有详情类 |
| `410-unpublished` | 用户端直链访问发布态=`false` 节 | 410 + "内容已下架" + 回首页 | P-app-course-002/007 |
