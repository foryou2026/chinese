<!-- TARGET-PATH: docs/C03-ia/discover-china/07-error-pages.md -->
...
## 6. 弹窗 / Drawer 清单(承自遗留 F3)

| D-ID | 名称 | 触发 | 类型 | 关键字段 |
|------|------|------|------|---------|
| D-1 | 新建文章 Modal | P-admin-discover-china-002 顶部 | Modal | 名称 5 语 + 拼音 |
| D-2 | 文章基本信息编辑(同页) | P-admin-discover-china-003 顶部区 | 内联区 | 名称 5 语 + 拼音 + 状态 |
...
| D-5 | 二次确认 Modal | 多处 | Modal 380px | 标题 + 详细操作 + 确认/取消 |
