...
> 本轮共 12 个问题（10 阻断 + 2 优化），每一处架构定调均可追溯到下方一次显式拍板。
...
- D2. 鉴权基础设施落 `09-auth-infra.md`；具体登录/注册页与流程落在未来的 `auth` / `auth` feature，不在 B 阶段输出。
- D3. dev 端口 fe=3100/4100 / be=8100/9100；与同主机其它项目已占用的 3100/3200/3300/3400 + 8100/8200/8300/8400 区段错峰共存（按 4100/9100 排开）。本项目 dev 共占用 3100、4100、8100、9100、6379 五个对外端口。
