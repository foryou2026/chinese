<!-- TARGET-PATH: docs/C04-pages/course/admin/P-admin-course-006.md -->
...
- D-7 内按钮:
  ...
  - [采纳] → D-8 选择关联动作(改了哪些字段)→ 标记 adopted(不自动改 发布态);
...
## 7. 不变量回链
R-024 历史 答题记录 不追溯、采纳/忽略不自动改发布、`content_action_log` 留痕。
