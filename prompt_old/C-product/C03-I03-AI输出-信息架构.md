...
> **阶段**：I 信息架构
> **谁产出**：AI（信息架构师）
> **落盘**：`docs/C03-ia/<feature-id>/`

---

## AI 必须遵守

1. **只读**：I 用户输入 + 本 feature R 基线 + C02 全部 + B02 / B03 索引 + I-questions-round*-resolved + `A00-01` + `A00-03` + `A00-04` + 本模板。
...
```
我已答完 I 澄清。请按 /prompt/C-product/C03-I03-AI输出-信息架构.md 多文件结构输出，
落盘到 docs/C03-ia/<feature-id>/。
菜单 / 角色映射必须引用 docs/C02-permissions/01-roles.md。
...
```markdown
<!-- TARGET-PATH: docs/C03-ia/<feature-id>/00-index.md -->

# 信息架构 · 索引

> **阶段**：I · 信息架构师
> **上游**：本 feature R 基线、C02、B02、B03、I-<feature-id>-questions-resolved
> **下游**：
> - C04 N：每页一份文件，page-id 来自本目录 04-pages.md
...
```markdown
<!-- TARGET-PATH: docs/C03-ia/<feature-id>/01-feature-catalog.md -->
...
```markdown
<!-- TARGET-PATH: docs/C03-ia/<feature-id>/02-flows.md -->
...
```markdown
<!-- TARGET-PATH: docs/C03-ia/<feature-id>/03-state-machines.md -->
...
```markdown
<!-- TARGET-PATH: docs/C03-ia/<feature-id>/04-pages.md -->
...
```markdown
<!-- TARGET-PATH: docs/C03-ia/<feature-id>/05-navigation.md -->
...
```markdown
<!-- TARGET-PATH: docs/C03-ia/<feature-id>/06-coverage-matrix.md -->
...
```markdown
<!-- TARGET-PATH: docs/C03-ia/<feature-id>/07-error-pages.md -->
...
```markdown
<!-- TARGET-PATH: docs/C03-ia/<feature-id>/99-open-questions.md -->
...
- [ ] 05-navigation 的角色都能在 docs/C02-permissions/01-roles.md 找到？
