...
```
我已答完 D 澄清。请按 /prompt/21-D-AI输出-数据规范.md 多文件结构输出，
落盘到 docs/40-data/<feature-id>/。
...
```markdown
<!-- TARGET-PATH: docs/40-data/<feature-id>/00-index.md -->
...
```markdown
<!-- TARGET-PATH: docs/40-data/<feature-id>/01-er-diagram.md -->
...
```markdown
<!-- TARGET-PATH: docs/40-data/<feature-id>/02-entities/<entity>.md -->
...
```markdown
<!-- TARGET-PATH: docs/40-data/<feature-id>/03-state-machines.md -->
...
```markdown
<!-- TARGET-PATH: docs/40-data/<feature-id>/04-business-rules.md -->
...
```markdown
<!-- TARGET-PATH: docs/40-data/<feature-id>/05-indexes.md -->
...
```markdown
<!-- TARGET-PATH: docs/40-data/<feature-id>/06-volume-growth.md -->
...
```markdown
<!-- TARGET-PATH: docs/40-data/<feature-id>/99-open-questions.md -->
