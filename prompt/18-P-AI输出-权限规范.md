...
```
我已答完 P 澄清。请按 /prompt/18-P-AI输出-权限规范.md 多文件结构输出到 docs/30-permissions/。
...
```markdown
<!-- TARGET-PATH: docs/30-permissions/00-index.md -->
...
```markdown
<!-- TARGET-PATH: docs/30-permissions/01-roles.md -->
...
```markdown
<!-- TARGET-PATH: docs/30-permissions/02-auth-flow.md -->
...
```markdown
<!-- TARGET-PATH: docs/30-permissions/03-authz-mechanism.md -->
...
```markdown
<!-- TARGET-PATH: docs/30-permissions/04-user-data-model.md -->
...
```markdown
<!-- TARGET-PATH: docs/30-permissions/05-registration.md -->
...
```markdown
<!-- TARGET-PATH: docs/30-permissions/99-open-questions.md -->
