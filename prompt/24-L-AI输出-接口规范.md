...
```
我已答完 L 澄清。请按 /prompt/24-L-AI输出-接口规范.md 多文件结构输出，
落盘到 docs/50-api/<feature-id>/。
...
```markdown
<!-- TARGET-PATH: docs/50-api/<feature-id>/00-index.md -->
...
```markdown
<!-- TARGET-PATH: docs/50-api/<feature-id>/01-overview.md -->
...
```markdown
<!-- TARGET-PATH: docs/50-api/<feature-id>/02-endpoints/<method>-<path>.md -->
...
```markdown
<!-- TARGET-PATH: docs/50-api/<feature-id>/03-error-codes.md -->
...
```markdown
<!-- TARGET-PATH: docs/50-api/<feature-id>/04-events.md -->
...
```markdown
<!-- TARGET-PATH: docs/50-api/<feature-id>/99-open-questions.md -->
