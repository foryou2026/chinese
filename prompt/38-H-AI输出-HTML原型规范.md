...
```
请你扮演"前端原型工程师"，遵循 /prompt/01、/prompt/03、/prompt/04，硬性遵守 docs/60-ux/、docs/70-design-system/、docs/80-ia/、docs/90-pages/。
按 /prompt/38-H-AI输出-HTML原型规范.md 输出一整套零依赖 HTML 原型，
落盘到 docs/A0-prototype/。
所有 token 直接以 :root CSS 变量呈现，与 docs/70 01-tokens 一字不差。
所有页面引用 page-id 与 docs/80-ia 02-pages 完全一致。
...
- DOM 结构按 `docs/90-pages/<feature-id>/<page-id>.md` §3 区块清单
...
## v2 · YYYY-MM-DD · 反馈轮 1
- 应反馈 docs/A0-prototype/_input/feedback-round1.md：
...
- [ ] 所有 page-id 与 `docs/80-ia/02-pages.md` 一致？
- [ ] P0 页面 4 状态齐？
