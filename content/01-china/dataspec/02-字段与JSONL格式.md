...
首期正式内容每篇 24–40 句，建议 32 句左右。一篇文章对应一篇可一气呵成、可朗读、专题感强的纪录片式介绍文（约 1500–2500 中文字）。**严禁**为了凑句数加入承接句、抒情转折或重复主题词的填充句；如果某主题确实写不到 24 句有效内容，应换更具体的子主题，而不是注水。需要更长内容时拆成系列文章。
...
- [ ] `sentences.length` 在 24–40 之间
- [ ] 首期 phase1 正式内容 `sentences.length` 在 24–40 之间，建议 32
